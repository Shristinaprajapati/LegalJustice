...
const divorceAgreementSchema = new mongoose.Schema({
  ...
  spouse1Name: { type: String, required: false },
  spouse1Debts: { type: String, required: false },
  spouse2Name: { type: String, required: false },
  spouse2Debts: { type: String, required: false },
  jurisdiction: { type: String, required: true },
  spouse1SignatureDate: { type: Date, required: false},
  spouse2SignatureDate: { type: Date, required: false},
