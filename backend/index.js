...
const rentalAgreement = require("./routes/rentalAgreementRoutes");
const marriageProof = require("./routes/marriageProofRoute");
const propertyAgreement = require("./routes/propertyTransferRoutes");
const EmploymentAgreement = require("./routes/employmentRoute");
...
app.use("/api/rental", rentalAgreement);
app.use("/api/marriageproof", marriageProof);
app.use("/api/propertytransfer", propertyAgreement);
app.use("/api/employment", EmploymentAgreement);
